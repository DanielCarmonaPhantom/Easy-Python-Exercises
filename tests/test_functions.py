class Function_testing:
    ...
    def test_excercise_four(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
    ...
    def test_excercise_five(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
    ...
    def test_excercise_six(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
    ...
    def test_excercise_seven(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
    ...
    def test_excercise_eight(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
    ...
    def test_excercise_nine(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
    ...
    def test_excercise_ten(self, resultado, esperado, prueba):
        self.resultado = resultado
        self.esperado = esperado
        if self.resultado == self.esperado:
            print(f'¡Superaste la prueba {prueba}!')
